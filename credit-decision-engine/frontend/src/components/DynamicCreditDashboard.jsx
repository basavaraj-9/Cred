  ...
  const fetchDynamicAnalysis = async (company) => {
    ...
    try {
      ...
      const analysis = await creditService.fetchCreditAnalysis(company.unique_hash, {
        ...
        revenue_history: [], // Will be populated by backend
        cash_flow_history: [], // Will be populated by backend
        litigation_count: 0 // Will be populated by backend
      });
        ...
        {!loading && Object.keys(dynamicAnalysis).length > 0 && (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#64748b', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                📊 Financial Health Metrics
              </h3>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                {dynamicAnalysis.financial_health_metrics && (
                  <>
                    <div style={{ textAlign: 'center' }}>
                      <div style={{ fontSize: '12px', color: '#64748b', marginBottom: '4px' }}>
                      ...
                      <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#1e293b' }}>
                        {dynamicAnalysis.financial_health_metrics.revenue_growth_score || 0}/100
                      </div>
                      <div style={{ fontSize: '11px', color: '#64748b', marginTop: '4px' }}>
                        Based on 12-month trend analysis
                      </div>
                    </div>
                    <div style={{ textAlign: 'center' }}>
                      <div style={{ fontSize: '12px', color: '#64748b', marginBottom: '4px' }}>
                      ...
                      <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#1e293b' }}>
                        {dynamicAnalysis.financial_health_metrics.cash_flow_stability || 0}/100
                      </div>
                      <div style={{ fontSize: '11px', color: '#64748b', marginTop: '4px' }}>
                    ...
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#1e293b' }}>
                        {dynamicAnalysis.financial_health_metrics.debt_ratio || 0}/100
                      </div>
                      <div style={{ fontSize: '11px', color: '#64748b', marginTop: '4px' }}>
...
export default DynamicCreditDashboard;
